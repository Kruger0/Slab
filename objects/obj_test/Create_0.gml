...
//    new MenuNodeButton("options", "Options", function(){PagePush("options")}),
//    new MenuNodeSeparator("sep"),
//    new MenuNodeConfirm("exit", "Exit", function(){game_end()}, {message : "Exit Game?"}),
//]))
//.PageAdd(new MenuPage("options", "layerOptions", [
...
//    new MenuNodeButton("audio", "Audio", function(){PagePush("audio")}),
//    new MenuNodeButton("video", "Video", function(){PagePush("video")}),
//    new MenuNodeConfirm("reset", "Reset", function(){}, {message: "Are You Sure?"}),
//    new MenuNodeSeparator("sep"),
//    new MenuNodeButton("back", "Back", function(){PagePop()}),
//]))
//.PageAdd(new MenuPage("audio", "layerAudio", [
...
//    new MenuNodeButton("back", "Back", function(){PagePop()}),
//]))
//.PageAdd(new MenuPage("video", "layerVideo", [
